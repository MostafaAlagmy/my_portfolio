  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className='bg-tertiary flex flex-col flex-1 border-red-600 min-h-[571px]   p-5 rounded-2xl sm:w-[360px] w-full'
      >
...
const Works = () => {
  return (
    <>
      ...
      <div className='mt-20 items-stretch  flex flex-wrap gap-7'>
